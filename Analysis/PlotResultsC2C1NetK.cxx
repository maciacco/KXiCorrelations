...
void PlotResultsC2C1NetK(){
  gStyle->SetOptStat(0);

  TFile fpp("out_sys_17_finalBinning_c2c1_k.root"); // 17pq
  TFile fpPb("out_sys_16_finalBinning_c2c1_k.root"); // 17pq
  TFile f("out_sys_PbPb_finalBinning_c2c1_k.root"); // 15o+18qr
  ...
  TH2D frame("frame", ";#LTd#it{N}_{ch}/d#it{#eta}#GT;#it{#kappa}_{2}(K^{-} - K^{+})/#it{#kappa}_{1}(K^{-} + K^{+})", 1, 1.5, 2500, 1, 0.83, 1.01);
