...
void AnalysisSysPbPbCombined_finalBinning_K()
{
  gStyle->SetOptStat(0);
  TFile *fin = new TFile(kC2c1 ? "out_sys_15o_finalBinning__k_p.root" : "out_sys_15o_finalBinning_.root");
  TFile *fin2 = new TFile(kC2c1 ? "out_sys_18qr_finalBinning__k_p.root" : "out_sys_18qr_finalBinning_.root");
  TFile f(kC2c1 ? "out_sys_PbPb_finalBinning_k_p.root" : "out_sys_PbPb_finalBinning.root", "recreate");
  ...
  c.Write();
  cSys.Write();
  cSys.Print(kC2c1 ? "cSys_k_p.pdf" : "cSys.pdf");
  f.Close();
}
