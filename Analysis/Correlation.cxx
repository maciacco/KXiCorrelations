...
void Correlation (const char* inFileName = "o_merge_parallel_15o_full", const char* outFileName = "out_merge_parallel"){
  ...
  for (int iC = 0; iC < 2; ++iC){
    for (int iCorr = 0; iCorr < 3; ++iCorr){
      hCorrCentEffCorrCBWC[iC][iCorr] = new TH1D(Form("h%sCorrCentEffCorrCBWC_%s", kChargeLabel[iC], kCorrLabel[iCorr]), ";Centrality (%);#rho_{#Delta#Xi #Delta K}", kNCentBins, kCentBins);
      hCorrCentEffCorr_[iC][iCorr] = new TH1D(Form("h%sCorrCentEffCorr__%s", kChargeLabel[iC], kCorrLabel[iCorr]), ";Centrality (%);#rho_{#Delta#Xi #Delta K}", kNCentBinsSmall, kCentBinsSmall);
      ...
      for (int iCent = 0; iCent < kNCentBins; ++iCent){
        hCorrDistrEffCorrCBWC[iC][iCorr][iCent] = new TH1D(Form("h%sCorrDistrEffCorrCBWC_%s_%d", kChargeLabel[iC], kCorrLabel[iCorr], iCent), ";#rho_{#Delta#Xi #Delta K};Entries", 20000, -10., 10.);
        ...
        for (int iM = 0; iM < 2; ++iM){
          hAvgVarKDistrEffCorrCBWC[iC][iCorr][iCent][iM] = new TH1D(Form("h%s%sKDistrEffCorrCBWC_%s_%d", kAntiMatterLabel[iM], kAvgVarLabel[iC], kCorrLabel[iCorr], iCent), Form(";C_{%d}^{K};Entries", iC + 1), 400000, -20000., 20000.);
      ...
      for (int iCent = 0; iCent < kNCentBinsSmall; ++iCent){
        hCorrDistrEffCorr_[iC][iCorr][iCent] = new TH1D(Form("h%sCorrDistrEffCorr__%s_%d", kChargeLabel[iC], kCorrLabel[iCorr], iCent), ";#rho_{#Delta#Xi #Delta K};Entries", 20000, -10., 10.);
        ...
        for (int iM = 0; iM < 2; ++iM){
          hAvgVarKDistrEffCorr_[iC][iCorr][iCent][iM] = new TH1D(Form("h%s%sKDistrEffCorr__%s_%d", kAntiMatterLabel[iM], kAvgVarLabel[iC], kCorrLabel[iCorr], iCent), Form(";C_{%d}^{K};Entries", iC + 1), 400000, -20000., 20000.);
          hAvgVarXiDistrEffCorr_[iC][iCorr][iCent][iM] = new TH1D(Form("h%s%sXiDistrEffCorr__%s_%d", kAntiMatterLabel[iM], kAvgVarLabel[iC], kCorrLabel[iCorr], iCent), Form(";C_{%d}^{#Xi};Entries", iC + 1), 40000, -2000., 200.);
        }
      }
    }
  }
  for (int iS = 0; iS < N_SAMPLE; ++iS){
    ...
    for (int iCorr = 0; iCorr < (isMC ? 3 : 2); ++iCorr){
      ...
      for (int iCent = 0; iCent < kNCentBins; ++iCent){
        ...
        double avg_net_var_k = 0.;
        double avg_net_var_xi = 0.;
        ...
        for (int iSubCent = 0; iSubCent < N_SUB_CENT; ++iSubCent){
          ...
          avg_net_var_k += (n_ev * net_var_k);
          avg_net_var_xi += (n_ev * net_var_xi);
          for (int iC = 0; iC < 2; ++iC){
          ...
          for (int iC = 0; iC < 2; ++iC){
            hCorrDistrEffCorr_[iC][iCorr][hCent->FindBin(kCentBins[iCent] + iSubCent * delta + 0.001) - 1]->Fill(avg_corr_[iC] / sqrt(net_var_k * net_var_xi));
            hNetAvgVarKDistrEffCorr_[iC][iCorr][hCent->FindBin(kCentBins[iCent] + iSubCent * delta + 0.001) - 1]->Fill(net_var_k);
            hNetAvgVarXiDistrEffCorr_[iC][iCorr][hCent->FindBin(kCentBins[iCent] + iSubCent * delta + 0.001) - 1]->Fill(net_var_xi);
            for (int iM = 0; iM < 2; ++iM){
        ...
        for (int iC = 0; iC < 2; ++iC){
          hCorrDistrEffCorrCBWC[iC][iCorr][iCent]->Fill(avg_corr[iC] / sqrt( avg_net_var_k * avg_net_var_xi ));
          hNetAvgVarKDistrEffCorrCBWC[iC][iCorr][iCent]->Fill(avg_net_var_k / n_ev_tot);
          hNetAvgVarXiDistrEffCorrCBWC[iC][iCorr][iCent]->Fill(avg_net_var_xi / n_ev_tot);
          for (int iM = 0; iM < 2; ++iM){
