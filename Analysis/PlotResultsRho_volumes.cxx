...
void PlotResultsRho_volumes(){
  gStyle->SetOptStat(0);

  TFile fpp("out_sys_17_finalBinning.root"); // 17pq
  TFile fpPb("out_sys_16_finalBinning.root"); // 17pq
  TFile f("out_sys_PbPb_finalBinning.root"); // 15o+18qr
  ...
  TFile fSHM_BS_3_5("models/out_analysis_35.root");
  ...
  TH2D frame("frame", ";#LTd#it{N}_{ch}/d#it{#eta}#GT;#it{#rho}_{#Delta#Xi #DeltaK}", 1, 30, 2500, 1, -0.1, 0.05);
  TLegend leg(0.18, 0.71, 0.7, 0.88);
  ...
  //gSHM_BS[4] = (TGraphErrors*)fSHM_BS_2_6.Get("Grrho");

  gSHM_BS[4] = (TGraphErrors*)fSHM_BS_2_8.Get("Grrho");

  gSHM_BS[5] = (TGraphErrors*)fSHM_BS_2_9.Get("Grrho");

  gSHM_BS[6] = (TGraphErrors*)fSHM_BS_3.Get("Grrho");

  gSHM_BS[7] = (TGraphErrors*)fSHM_BS_3_1.Get("Grrho");

  gSHM_BS[8] = (TGraphErrors*)fSHM_BS_3_2.Get("Grrho");

  gSHM_BS[9] = (TGraphErrors*)fSHM_BS_3_3.Get("Grrho");

  gSHM_BS[10] = (TGraphErrors*)fSHM_BS_3_4.Get("Grrho");

  gSHM_BS[11] = (TGraphErrors*)fSHM_BS_3_5.Get("Grrho");

  gSHM_BS[12] = (TGraphErrors*)fSHM_BS_4.Get("Grrho");
  ...
  t.SetTextFont(44);
  t.SetTextSize(30);
  t.DrawLatex(37, -0.075, "|#it{#eta}| < 0.8");
  ...
  gData.Write();
  cResult.Write();
  cResult.Print("cRho_volumes.pdf"/* .pdf" */);
  ...
  std::cout << "chi2 = " << utils::chi2(gPbPb_stat, gPbPb_sys, gSHM_BS[7]) << std::endl;
