...
constexpr const char* kEffKFile = "KaonEff";
constexpr const char* kEffXiFile = "XiEff";
...
constexpr const char* kCorrLabel[2] = {"Uncorr", "Corr"};
...
constexpr double kNsigmaTOFcut = 3.;
constexpr double kTPCptCut = 0.5;
constexpr double kTOFptCut = 1.5;
constexpr double kXiLowPtCut = 1.;
constexpr double kXiUpPtCut = 4.;
